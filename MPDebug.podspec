#
# Be sure to run `pod lib lint MPDebug.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'MPDebug'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MPDebug.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'MPDebug/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MPDebug' => ['MPDebug/Assets/*.png']
  # }
